...
function preload(){
  ...
  groundImage = loadImage("groud202.png");
  ...
  gameOverImg = loadImage("Game_Over202.png");
  restartImg = loadImage("system-restart-panel.webp");
}
...
function setup() {
  ...
  ground = createSprite(400,250,400,20);
